...
- **Improvements:**
  ...
  - Enhanced skill generation with schema validator and improved component alignment with the new frontmatter schema.
...
- Refactor: Removed commands layer and renamed skills to match command names.
- Improvement: Created a canonical schema to standardize component metadata.
- Improvement: Aligned all components with the new frontmatter schema.
...
- Refactor: Removed commands layer and renamed skills to match command names.
- Documentation: Created a canonical schema to standardize component metadata.
...
- **Features**
  ...
  - Enhanced skill generation with schema validator and frontmatter validation.

- **Improvements**
  - Standardized component metadata with the creation of a canonical schema.
