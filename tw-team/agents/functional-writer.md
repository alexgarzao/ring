...
**Good:** "Core one uses a microservices architecture, which allows each component to be self-sufficient."

**Avoid:** "Core one might use what some call a microservices architecture, which could potentially allow components to be somewhat self-sufficient."
