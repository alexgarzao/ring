...
| 12 | [Directory Structure](#directory-structure-backend) | Project layout (Core one pattern) |
...
The directory structure follows the **Core one pattern** - a simplified hexagonal architecture without explicit DDD folders.
