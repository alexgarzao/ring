...
Task:
  ...
  prompt: |
    **MODE: ANALYSIS ONLY**
    ...
    Input:
    - Ring Standards: Load via WebFetch (golang.md or typescript.md based on project)
...
**Process:**
1. **Parse the WebFetch result** - Extract ALL `## Section` headers from golang.md or typescript.md (testing-related sections)
...
**Expected (from Ring Standard - golang.md/typescript.md):**
[Quote the relevant code/pattern from WebFetch result]

**Gap Analysis:**
- What is different
- What needs to be improved
- Standard reference: golang.md/typescript.md → [Section Name]
```
