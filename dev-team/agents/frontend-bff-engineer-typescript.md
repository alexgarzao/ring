...
You have deep expertise in Clean Architecture and Hexagonal Architecture. The **Core one pattern** (simplified hexagonal without explicit DDD folders) is MANDATORY for all BFF services.
