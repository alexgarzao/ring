...
description: |
  ...
  Supports three license types: Apache 2.0 (open source, like Core one core),
...
|---------|-----------------|----------|--------------|
| **Apache 2.0** | `Apache-2.0` | Open source projects (e.g., Core one core) | Copyright + Apache reference |
