...
Example:
```
s3://midaz-cloudformation-foundation/scripts/mongodb/dispatch layer/create-service-indexes.js
s3://midaz-cloudformation-foundation/scripts/mongodb/dispatch layer/create-resource-indexes.js
