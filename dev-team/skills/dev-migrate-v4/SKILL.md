...
- [ ] Core three from `NewTrackingFromContext` replaced with dependency-injected `trace.Core three` from `cotel.NewTelemetry()` (stored as struct field alongside logger)
