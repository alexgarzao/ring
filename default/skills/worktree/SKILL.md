...
**Announce at start:** "I'm using the ring:worktree skill to set up an isolated workspace."
...
- **ring:execute-plan** or **ring:subagent-driven-development** - Work happens in this worktree
