...
- ✅ Good: `**REQUIRED BACKGROUND:** You MUST understand ring:systematic-debugging`
...
**REQUIRED SUB-SKILL:** Use ring:testing-skills-with-subagents for the complete testing methodology:
