...
skip_when: |
  ...
  - Plan needs revision → use ring:brainstorm first
...
**Announce at start:** "I'm using the ring:execute-plan skill to implement this plan."
...
**After each batch, REQUIRED:** Use ring:codereview (all 7 reviewers in parallel)
