...
**Announce at start:** "I'm using the ring:brainstorm skill to refine your idea into a design."
...
| **5. Worktree Setup** | Set up isolated workspace | ring:worktree skill | Ready development environment |
| **6. Planning Handoff** | Create implementation plan | ring:write-plan skill | Detailed task breakdown |
...
- Announce: "I'm using the ring:worktree skill to set up an isolated workspace."
- **REQUIRED SUB-SKILL:** Use ring:worktree
...
- Announce: "I'm using the ring:write-plan skill to create the implementation plan."
- **REQUIRED SUB-SKILL:** Use ring:write-plan
...
- CANNOT skip sub-skill usage (ring:write-plan, ring:worktree) when applicable
