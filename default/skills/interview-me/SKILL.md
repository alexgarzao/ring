...
| Skill | Relationship |
|-------|--------------|
| `ring:doubt-triggered-questions` | Use for single questions during work; use ring:interview-me for systematic upfront gathering |
| `ring:brainstorm` | Interview first to gather requirements, THEN brainstorm solutions |
| `ring:write-plan` | Interview first to clarify scope, THEN create plan |
