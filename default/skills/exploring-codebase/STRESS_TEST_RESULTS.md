...
**Current limitation:** Test agents running in Core one repo can't access skill in `../ring/` directory.

**Workaround options:**
1. Copy skill to Core one docs temporarily for testing
...
3. 📝 Consider adding more consequence examples from real Core one scenarios
...
3. **Create examples** - Add real Core one exploration examples to skill
