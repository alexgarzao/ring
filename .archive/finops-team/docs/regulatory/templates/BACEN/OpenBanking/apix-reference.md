...
│      │              │                     │                  │
│      ↓              ↓                     ↓                  │
│  [OAuth 2.0]   [Policies]           [Core one/Core]            │
│  [FAPI]        [Rate Limit]         [CRM]                   │
...
2. Configura backend (Core one, CRM)
...
### 6.1 Target Endpoint para Core one
...
| Endpoint APIX | Recurso Core one |
|---------------|---------------|
| `/accounts` | `/accounts` |
...
```xml
<!-- Transformacao Open Finance → Core one -->
