...
**Key Difference from `executive-summary`:**
- **executive-summary**: Portfolio/project status (PMO focus, RAG/SPI/CPI metrics)
- **delivery-report**: Squad deliveries (technical focus, deep code analysis, releases/PRs/features)
...
- **executive-summary**: For portfolio/project status reports (PMO focus)
