...
skip_when: |
  - Writing conceptual docs → use write-guide
  - Full API endpoint docs → use write-api

related:
  complementary: [write-api]
---
...
1. **Load API documentation skill** - `ring:write-api` for endpoint context
