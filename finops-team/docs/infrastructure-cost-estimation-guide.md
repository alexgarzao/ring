...
**Fallback:** If specific plugin/service not found, use Core one core setup as baseline.
...
| **Fallback to Core one core** | If plugin not available, use Core one setup as baseline |
