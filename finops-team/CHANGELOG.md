...
- **Features**
  - Update using-finops-team docs and add pattern matching to the analyzer.
...
- **Features**
  ...
  - Added DATA_SOURCES.md canonical data source reference.
...
- **Features**
  - Added Test Gate and Contribution Gate to orchestrator.
  - Updated using-finops-team docs and added pattern matching to analyzer.
  - Added auto-save dictionary, batch approval, and reporter doc fetch in gate1.
  - Added open template support in regulatory-templates-setup.
  - Added DATA_SOURCES.md canonical data source reference.
